...
const mockNotifications = [
  { id: 1, type: 'success', message: 'Insurance plan "IP-001" has been approved.', time: '2 hours ago', read: false },
  { id: 2, type: 'error', message: 'Failed to process payment for plan "IP-002".', time: '1 day ago', read: false },
  { id: 3, type: 'warning', message: 'Your subscription is expiring in 3 days.', time: '2 days ago', read: true },
  { id: 4, type: 'info', message: 'A new user has applied for an insurance plan.', time: '3 days ago', read: true },
];
