      ...
      {isOpen && (
        <div className={styles.chatPopup}>
          ...
          <div className={styles.quickActions}>
            <button className={styles.quickButton}>Find a car</button>
            <button className={styles.quickButton}>Book service</button>
            <button className={styles.quickButton}>Contact us</button>
          </div>
          ...
          <div className={styles.popupFooter}>
            <a href="/chat" className={styles.expandLink}>
              Open full chat
            </a>
          </div>
        </div>
