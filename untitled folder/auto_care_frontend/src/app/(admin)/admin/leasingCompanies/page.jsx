...
const LeasingCompaniesPage = () => {
  ...
  const stats = {
    ...
    totalVehiclesLeased: companies.reduce((acc, c) => acc + c.vehiclesLeased, 0)
  };
          ...
          <div className={styles.content}>
            ...
            <div className={styles.header}>
              <div className={styles.headerContent}>
                <h1 className={styles.title}>Leasing Companies</h1>
                <p className={styles.subtitle}>Manage leasing company accounts</p>
              </div>
            ...
            <div className={styles.statsGrid}>
                ...
                <Card className={styles.statCard}>
                    <div className={styles.statIcon}><Building size={24} /></div>
                    <div className={styles.statContent}>
                        <div className={styles.statNumber}>{stats.totalVehiclesLeased}</div>
                        <div className={styles.statLabel}>Vehicles Leased</div>
                    </div>
                </Card>
            </div>
                  ...
                  <tbody>
                    {filteredCompanies.map((company) => (
                      <tr key={company.id}>
                        ...
                        <td className={styles.vehicleCount}>{company.vehiclesLeased}</td>
                        <td>
        ...
        {selectedCompany && (
          <div className={styles.dialogContent}>
            ...
            <div className={styles.userDetails}>
              ...
              <div className={styles.detailItem}><label>Vehicles Leased:</label><span>{selectedCompany.vehiclesLeased}</span></div>
